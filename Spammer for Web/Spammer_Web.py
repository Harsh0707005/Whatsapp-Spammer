...
def Process():
    ...
    # asking for message to be sent
    msg = input("Enter the message that you want to spam... ")

    # asking for number of times message to be spammed
    ...
    # as pywhatkit requires 20 second of wait time by default.
    if today_date.second >= 35:
        minute = minute + 2
    else:
        minute = minute + 1
